...
<script language="javascript">
	function fn_Chart(){
		...
		var pChart = new FusionCharts({'swfUrl': 'MSColumnLine3D.swf', 'id': 'myChartId', 'width': '488', 'height': '192', 'debugMode': '0', 'registerWithJS': '1', renderer: 'JavaScript'});
		pChart.setDataURL('S210001_C01Xml.jsp'+url);
