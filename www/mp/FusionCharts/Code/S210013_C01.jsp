...
<%
	String sDealer = (String)request.getParameter("DEALER_ID");
...
<script language="javascript">
	function fn_Chart(){
		...
		url += "&DEALER_ID=<%=sDealer%>";
		url += "&SVC=<%=sSvc%>";

		var pChart = new FusionCharts({'swfUrl': 'MSColumnLine3D.swf', 'id': 'myChartId', 'width': '141', 'height': '225', 'debugMode': '0', 'registerWithJS': '1', renderer: 'JavaScript'});
