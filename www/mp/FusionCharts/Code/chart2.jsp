...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
	...
	url += "&YYYYMM="+parent.FV_sToMonthDay;
	url += "&TODAY="+parent.FV_sToday;
		
	var pChart = new FusionCharts({'swfUrl': 'MSLine.swf', 'id': 'javascript-chart', 'width': '486', 'height': '190', 'debugMode': '0', 'registerWithJS': '0', renderer: 'javascript'});
	pChart.setDataURL('chart2Xml.jsp'+url);
