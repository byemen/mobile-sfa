...
<chart showLegend='1' 
   ...
   <dataset seriesName="S.Target" color="C0C0C0" anchorBorderThickness="0" anchorBgColor="C0C0C0" anchorBorderColor='FFFFFF' renderAs="Line" showvalues='0' >
		<%=sMakeDataSet1%>
   </dataset>
   <dataset seriesName="Sales" color="e23b45" anchorBorderThickness="0" anchorBgColor="e23b45" anchorBorderColor='FFFFFF' renderAs="Line" showvalues='0' >
		<%=sMakeDataSet2%>
   </dataset>
</chart>
