...
<script language="javascript">
	function fn_Chart(){
		...
		var pChart = new FusionCharts({'swfUrl': 'MSLine.swf', 'id': 'javascript-chart', 'width': '502', 'height': '144', 'debugMode': '1', 'registerWithJS': '0', renderer: 'javascript'});
		pChart.setDataURL('S210001_C03Xml.jsp'+url);
