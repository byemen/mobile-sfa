...
<script language="javascript">
	function fn_Chart(){
		...
		var pChart = new FusionCharts({'swfUrl': 'MSCombi2D.swf', 'id': 'myChartId', 'width': '802', 'height': '428', 'debugMode': '0', 'registerWithJS': '1', renderer: 'JavaScript'});
		pChart.setDataURL('S210001_CP02Xml.jsp'+url);
