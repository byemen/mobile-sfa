...
//		con = getConnection(sAction);   
		...
		SqlRequest sqlRequest1 = SqlMapManagerUtility.makeSqlRequest("mdms/mp/eis:S210002_W01_S01");		
		SqlRequest sqlRequest2 = SqlMapManagerUtility.makeSqlRequest("mdms/mp/eis:S210002_W01_S02");
