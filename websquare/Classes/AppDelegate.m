...
//  websquare
//
//  Created by Jun Hoyoon on 12. 3. 8..
//  Copyright Inswave 2012. All rights reserved.
//
...
static NSString *startPageHoyoon = @"index.html"; //Class variable 
...
+ (NSString *) startPage 
{
    ...
    if(!temp) {
        ...
        startPageHoyoon = @"index.html";
    } else {
        startPageHoyoon = [temp objectForKey:@"startPage"];
    }  
    NSLog(@"startPage : %@", startPageHoyoon);
    return startPageHoyoon;
}
...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"websquare launchOptions = %@", url);
    }    
    ...
    self.viewController.startPage = [AppDelegate startPage];
